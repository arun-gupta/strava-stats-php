<div>
    ...
    <!-- Summary Cards -->
    <div style="margin-top: 0.75rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 0.5rem;">
        <!-- Date Range Card -->
        <div style="padding: 0.75rem; background: white; border-radius: 8px; border: 2px solid #e2e8f0;">
            <div style="font-size: 0.7rem; color: #666; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.125rem;">
                📅 Date Range
            </div>
            <div style="font-size: 1rem; font-weight: 600; color: #333;">
                <?= $startDate->format('M j') ?> - <?= $endDate->format('M j, Y') ?>
            </div>
            <div style="font-size: 0.7rem; color: #666; margin-top: 0.125rem;">
        ...
        <div style="padding: 0.75rem; background: white; border-radius: 8px; border: 2px solid #e2e8f0;">
            ...
            <div style="font-size: 1.5rem; font-weight: 700; color: #fc4c02;">
                <?= $totalActivities ?>
            </div>
            <div style="font-size: 0.7rem; color: #666; margin-top: 0.125rem;">
    ...
    <!-- Date Range Selector -->
    <div style="margin-top: 0.75rem; padding: 0.5rem; background: white; border-radius: 8px; border: 2px solid #e2e8f0;">
        <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 0.4rem; justify-content: center;">
            <span style="font-weight: 600; color: #333; font-size: 0.8rem;">📅 Time Period:</span>
    ...
    <!-- Tab Navigation -->
    <nav style="margin-top: 0.75rem;" aria-label="Dashboard sections">
        <div role="tablist" style="display: flex; gap: 0.125rem; border-bottom: 2px solid #e2e8f0;">
            <button id="overviewTab"
                    ...
                    style="padding: 0.5rem 1rem; background: none; border: none; border-bottom: 3px solid #fc4c02;
            ...
            <button id="durationTab"
                    ...
                    style="padding: 0.5rem 1rem; background: none; border: none; border-bottom: 3px solid transparent;
