...
<div style="padding: 3rem 0; text-align: center;">
    <div style="max-width: 600px; margin: 0 auto; padding: 2rem; background: #fff3cd; border: 2px solid #ffc107; border-radius: 8px;">
    ...
    <?php if ($errorType !== 'unknown'): ?>
        <p style="margin-top: 2rem; color: #666; font-size: 0.9rem;">
            Error code: <code style="background: #f5f5f5; padding: 2px 6px; border-radius: 3px;"><?= htmlspecialchars($errorType) ?></code>
        </p>
    <?php endif; ?>
</div>
