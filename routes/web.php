    ...
    $app->get('/dashboard', function (Request $request, Response $response) {
        ...
        if ($accessToken) {
            try {
                ...
                // Cache version changed - now using local timezone (v4)
                $cacheKey = 'activities_cache_v4';
                $cacheStartDateKey = 'activities_cache_start_date_v4';

                // Clear old cache versions if they exist
                if (isset($_SESSION['activities_cache']) || isset($_SESSION['activities_cache_v2']) || isset($_SESSION['activities_cache_v3'])) {
                    ...
                    unset($_SESSION['activities_cache_v3']);
                    unset($_SESSION['activities_cache_start_date_v3']);
                }
